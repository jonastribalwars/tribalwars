  ...
  var constructor = function () {
    if ( $( ".iwan_scripts_popup" ).length == 0 ) {
      ...
      function nameWithNumber( $villageEdit ) {
        ...
        villageName += new Array(params["spaties"]+1).join();
      ...
      $('#rename_method_2_more_spatie').change( function () {
        if ($(this).is(":checked")) {
          $( "#rename_method_2_more_spaties_na_nummer" ).show();
          params["spaties"] = $("#rename_method_2_spaties_aantal").val();
        }
        else {
          $( "#rename_method_2_more_spaties_na_nummer" ).hide();
        }
      });
