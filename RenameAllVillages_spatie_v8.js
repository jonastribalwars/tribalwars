  ...
  var constructor = function () {
    if ( $( ".iwan_scripts_popup" ).length == 0 ) {
      ...
      ('#rename_method_2_more_spatie').on("change", function () {
        if (!this.checked) {
          $( "#rename_method_2_spaties_aantal" ).show();
